...
class _$LocationStateImpl implements _LocationState {
  _$LocationStateImpl({this.langitude = 0.0, this.longitude = 0.0});
  ...
  @override
  String toString() {
    return 'LocationState(langitude: $langitude, longitude: $longitude)';
  }
...
abstract class _LocationState implements LocationState {
  factory _LocationState({final double langitude, final double longitude}) =
      _$LocationStateImpl;
